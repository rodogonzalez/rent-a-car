    ...
    <div class="box two my-element animate__animated" data-animation-class="animate__bounceInLeft">
        <h3>Marcos</h3>
        <span>★★★★★</span>
    ...
    <div class="box three my-element animate__animated" data-animation-class="animate__bounceInLeft">
        <h3>Lucía</h3>
        <span>★★★★✰</span>
    ...
    <div class="box four my-element animate__animated" data-animation-class="animate__bounceInLeft">
        <h3>Carmen</h3>
        <span>★★★★★</span>
