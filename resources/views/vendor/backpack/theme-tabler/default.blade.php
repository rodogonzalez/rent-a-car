...
<head>
    ...
    <meta property="og:image" content="https://www.INFOTURISTICA / VUELA OK.net/images/thumb.jpg" />
    <meta property="og:description" content="Renta tu Auto en Costa Rica al Mejor Precio y con Súper Beneficios." />

    <link href="https://cdn.prod.website-files.com/61af8b52b18b8403908b7c33/61af8b52b18b84484c8b7cec_favicon.png"
...
<body id="app" class=" landing_page animate__animated" bp-layout="plain">
    ...
    <footer class="text-center">
        ...
        {!! __('rent-a-car.booking_disclaimer') !!}
        <hr>
