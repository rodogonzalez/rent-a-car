    ...
    function get_rates()
    {
        ...
        return [
            [
                ...
                "date_end"      => "31/05/2026",
                "vehicle_rates" => [
                    ["code" => "ECAR", "price" => "29.00"],
                    ["code" => "CCAR", "price" => "30.00"],
                    ["code" => "ICAR", "price" => "33.00"],
                    ["code" => "EFAR", "price" => "34.00"],
                    ["code" => "CFAR", "price" => "35.00"],
                    ["code" => "IFAR", "price" => "41.00"],
                    ["code" => "XFAR", "price" => "39.00"],
                    ["code" => "SFAR", "price" => "48.00"],
                    ["code" => "CJAR", "price" => "37.00"],
                    ["code" => "SJAR", "price" => "46.00"],
                    ["code" => "FPAR", "price" => "85.00"],
                    ["code" => "FFAR", "price" => "49.00"],
                    ["code" => "PFAR", "price" => "61.00"],
                    ["code" => "FVMR", "price" => "105.00"],
                    ["code" => "FVAR", "price" => "105.00"],
                    ["code" => "FVBR", "price" => "121.00"],
                    ["code" => "LFAR", "price" => "152.00"],
                ]
            ],
            [
            ...
            [
                ...
                "date_end"      => "31/07/2026",
                "vehicle_rates" => [
                    ["code" => "ECAR", "price" => "39.00"],
                    ["code" => "CCAR", "price" => "39.00"],
                    ["code" => "ICAR", "price" => "40.00"],
                    ["code" => "EFAR", "price" => "43.00"],
                    ["code" => "CFAR", "price" => "43.00"],
                    ["code" => "IFAR", "price" => "50.00"],
                    ["code" => "XFAR", "price" => "47.00"],
                    ["code" => "SFAR", "price" => "54.00"],
                    ["code" => "CJAR", "price" => "47.00"],
                    ["code" => "SJAR", "price" => "70.00"],
                    ["code" => "FPAR", "price" => "89.00"],
                    ["code" => "FFAR", "price" => "77.00"],
                    ["code" => "PFAR", "price" => "83.00"],
                    ["code" => "FVMR", "price" => "142.00"],
                    ["code" => "FVAR", "price" => "142.00"],
                    ["code" => "FVBR", "price" => "165.00"],
                    ["code" => "LFAR", "price" => "207.00"],
